...
const DEFAULT_PROFILE_PICTURE = "/api/static/images/default-profile.png";
const LOCAL_STORAGE_KEY = "profile_picture_url";


// ✅ สำหรับ DevTools Debug โดยเฉพาะ
...
const Profile = () => {
  ...
  const profilePictureUrl = useMemo(() => {
    ...
    const fullUrl = !path
      ...
      ? path
      : `${process.env.REACT_APP_API_BASE_URL || window.location.origin}${path}`;
